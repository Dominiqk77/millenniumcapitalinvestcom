...
const ProcessSection = () => {
  ...
  return (
    <section
      id="process"
      ref={sectionRef}
      className="relative overflow-hidden bg-background-deep py-24 md:py-32"
    >
      {/* Background */}
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <div className="absolute left-8 top-0 hidden h-full w-px bg-border/30 md:left-1/2 md:block">
            <motion.div
              ...
              className="w-full bg-gradient-to-b from-primary via-primary to-primary/20"
            />
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className={`flex-1 ${isEven ? 'md:pr-16 md:text-right' : 'md:pl-16'}`}>
                    <div className={`glass-card p-6 ${isEven ? 'md:ml-auto' : ''} max-w-md`}>
                      <span className="mb-2 block text-4xl font-bold text-primary/30">
                        {step.number}
                      </span>
