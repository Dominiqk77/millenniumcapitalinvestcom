    ...
    <section className="relative overflow-hidden gradient-mesh-bg py-24 md:py-32">
      ...
      <div className="section-container relative z-10">
        <div className="mb-16 text-center">
          <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }} className="text-3xl font-medium text-foreground md:text-4xl lg:text-5xl metallic-text text-glow">{t('features.title')}</motion.h2>
        </div>
            ...
            return (
              <motion.div key={feature.titleKey} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: index * 0.1 }} viewport={{ once: true }} className="glass-card-glow group relative p-6">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="mb-2 text-lg font-medium text-foreground">{t(feature.titleKey)}</h3>
