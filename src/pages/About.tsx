      ...
      <main>
        <section className="relative overflow-hidden bg-background-deep pt-32 pb-20 lg:pt-40 lg:pb-28">
          ...
          <div className="section-container relative z-10 text-center">
            <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="mb-6 text-4xl font-medium text-foreground md:text-5xl lg:text-6xl">About <span className="gradient-text-primary">Millennium Capital Invest</span></motion.h1>
            <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="mx-auto max-w-2xl text-lg text-muted-foreground">We architect and deploy next-generation AI, FinTech, and GovTech platforms for high-stakes environments — delivering digital sovereignty and measurable institutional ROI.</motion.p>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="glass-card-glow p-8 lg:p-12">
              <div className="flex flex-col gap-8 md:flex-row">
                ...
                <div>
                  <h3 className="mb-1 text-2xl font-medium text-foreground">Dominiqk Mendy</h3>
                  <p className="mb-4 text-primary">Founder & CEO — Global AI Expert & Digital Sovereignty Architect</p>
                  <p className="text-muted-foreground leading-relaxed">With 15+ years of multi-regional expertise spanning the US, Europe, Africa, and the Middle East, Dominiqk Mendy leads Millennium Capital Invest's mission to deliver institutional-grade technology solutions. His vision bridges proven international security standards (GDPR/RGPD, US Compliance) with the world's most complex implementation challenges.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="gradient-mesh-bg py-16">
          <div className="section-container text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Button variant="premium" size="lg" asChild><a href="/#contact">Book a Call</a></Button>
              <Button variant="outline" size="lg" asChild><a href="/#contact">Request Investor Deck</a></Button>
            </div>
          </div>
        </section>
      </main>
