...
const products = [
  {
    ...
    statusKey: 'products.beta',
    badgeClass: 'badge-teal',
    glowColor: 'brand-teal',
  },
  {
    key: 'senepay',
    url: 'https://sene-pay.com',
    statusKey: 'products.development',
...
const Products = () => {
  ...
  useEffect(() => {
    document.title = 'Products — Millennium Capital Invest';
  }, []);
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="section-container -mt-8 relative z-10">
        <motion.div
          ...
          className="glass-card flex items-start gap-4 p-5 border-brand-orange/30"
        >
          ...
          {products.map((product, i) => (
            ...
            >
              <div className="mb-4 flex items-center justify-between">
                ...
                <span className={`rounded-full px-3 py-1 text-xs font-medium border ${product.badgeClass}`}>
                  {t(product.statusKey)}
                </span>
              </div>
      ...
      <section className="bg-background-deep py-20">
        <div className="section-container text-center">
          <h2 className="mb-6 text-3xl font-bold text-foreground">{t('products.cta')}</h2>
          <div className="flex flex-wrap justify-center gap-4">
            <Button variant="premium" size="lg" asChild>
              <Link to="/partnerships">{t('partnerships.formSubmit')}</Link>
            </Button>
