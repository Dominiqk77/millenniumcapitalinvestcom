      ...
      <main className="section-container py-16 lg:py-24">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="space-y-8 text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="mb-4 text-xl font-semibold text-foreground">3. GDPR/RGPD Compliance</h2>
            ...
            <section>
              <h2 className="mb-4 text-xl font-semibold text-foreground">4. Data Sovereignty</h2>
