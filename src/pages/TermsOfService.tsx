    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="section-container py-16 lg:py-24">
        <div className="mx-auto max-w-3xl">
          <h1 className="mb-8 text-4xl font-medium text-foreground">Terms of Service</h1>
          <p className="mb-6 text-sm text-muted-foreground">Last updated: July 2025</p>

          <div className="space-y-8 text-muted-foreground leading-relaxed">
            <section>
              <h2 className="mb-4 text-xl font-medium text-foreground">1. Agreement to Terms</h2>
            ...
            <section>
              <h2 className="mb-4 text-xl font-medium text-foreground">2. Services</h2>
            ...
            <section>
              <h2 className="mb-4 text-xl font-medium text-foreground">3. Intellectual Property</h2>
            ...
            <section>
              <h2 className="mb-4 text-xl font-medium text-foreground">4. Limitation of Liability</h2>
            ...
            <section>
              <h2 className="mb-4 text-xl font-medium text-foreground">5. Governing Law</h2>
            ...
            <section>
              <h2 className="mb-4 text-xl font-medium text-foreground">6. Company Information</h2>
              <p>
